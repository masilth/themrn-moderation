...
exports.run = async (client, message, args) => {
  ...
  if (capslock) {
    ...
    message.channel.send(`Capslock Engelleme Sistemi Kapatıldı <a:re:753579010427977768>`)
  }
 
  if (!capslock) {
    db.set(`capslock_${message.guild.id}`, 'acik')
    message.channel.send(`Capslock Engelleme Sistemi  Başarıyla Aktif <a:on:752561537138425857> `)
  }
};
exports.conf = {
  enabled: true,
